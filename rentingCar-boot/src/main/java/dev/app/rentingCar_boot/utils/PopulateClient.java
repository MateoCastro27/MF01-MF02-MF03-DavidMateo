...
public class PopulateClient {
    ...
    public PopulateStatus populateClient(int qty) {
        ...
        try {
            ...
            // Guardar todos los clientes al final
            clientRepository.saveAll(clients); // Usa saveAll para eficiencia
            messageBuilder.append(" Operation 1: Generated and saved ").append(clients != null ? clients.size() : 0)
    ...
    private List<Client> generateClients(int qty) {
